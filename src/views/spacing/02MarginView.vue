<template>
  <main>
    <h1>Margin</h1>
    <h2>set an element's margin</h2>
    <h3 class="font-mono">m{t|r|b|l}-{size}</h3>
    <h3 class="font-mono">size : m-mx|mx-mx|my-mx|mt-mx|mr-mx|mb-mx|ml-mx</h3>
    <h3 class="font-mono">size : 0|0.5|1|1.5|2|2.5|3|3.5|</h3>
    <h3 class="font-mono">size : 4|5|6|7|8|9|10|11|12|</h3>
    <h3 class="font-mono">size : 14|16|20|24|28|32|36|40|44|48</h3>
    <h3 class="font-mono">size : 52|56|60|64|72|80|96</h3>

    <div class="grid-col-1 grid gap-8 py-8">
      <div>
        <h3 class="font-mono">m{t|r|b|l}-{size}</h3>
        <p class="font-mono">add padding to one side of an element</p>
        <div class="flex justify-center">
          <div class="mt-6 border-2 border-indigo-500">File</div>
          <div class="mr-4 border-2 border-indigo-500">Edit</div>
          <div class="mb-8 border-2 border-indigo-500">View</div>
          <div class="ml-6 border-2 border-indigo-500">Help</div>
        </div>
      </div>
...
ml-auto	margin-left: auto; -->
      ...
      Add margin to a single side Control the margin on one side of an element using the m{t|r|b|l}-{size}
      utilities. For example, mt-6 would add 1.5rem of margin to the top of an element, mr-4 would add 1rem of
      margin to the right of an element, mb-8 would add 2rem of margin to the bottom of an element, and ml-2
      ...
      Add horizontal margin Control the horizontal margin of an element using the mx-{size} utilities. mx-8
      <div class="... mx-8">mx-8</div>

      Add vertical margin Control the vertical margin of an element using the my-{size} utilities. my-8
      <div class="... my-8">my-8</div>

      Add margin to all sides Control the margin on all sides of an element using the m-{size} utilities. m-8
      <div class="... m-8">m-8</div>

      Using negative values To use a negative margin value, prefix the class name with a dash to convert it to
      a negative value. -mt-8
      ...
      <div>
        <h3 class="font-mono">px-{size}</h3>
        <p class="font-mono">add horizontal padding to an element</p>
        <div class="flex justify-center">
          <div class="border-2 border-indigo-500 px-8">File</div>
        </div>
      </div>

      <div>
        <h3 class="font-mono">py-{size}</h3>
        <p class="font-mono">add vertical padding to an element</p>
        <div class="flex justify-center">
          <div class="border-2 border-indigo-500 py-8">File</div>
        </div>
      </div>

      <div>
        <h3 class="font-mono">p-{size}</h3>
        <p class="font-mono">add padding to all sides of an element</p>
        <div class="flex justify-center">
          <div class="border-2 border-indigo-500 p-8">File</div>
        </div>
      </div>

      <div>
        <h3 class="font-mono">arbitrary values</h3>
        <div class="flex justify-center">
          <div class="border-2 border-indigo-500 p-[15px]">File</div>
        </div>
      </div>
    </div>
  </main>
