...
<script setup>
const items = [
  { name: 'Scale', href: '/transforms/scale' },
  { name: 'Rotate', href: '/transforms/rotate' },
  { name: 'Translate', href: '/transforms/translate' },
  { name: 'Skew', href: '/transforms/skew' },
  { name: 'Transform Origin', href: '/transforms/transformorigin' },
]
</script>
